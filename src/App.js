                ...
                <Row>
                    <Col md={{span: 8, offset: 2}} xxl={{span: 6, offset: 3}}>
                        <Section className="mt-4">
                            ...
                            My life goal is having my own job and creating a software community that everyone can get
                            benefit from.
                        ...
                        <Section className="mt-4" primary>
                            <h5>
                                ...
                                <span className="mx-3">
                      <MaeLink target="_blank"
                               href="https://drive.google.com/uc?id=1YW1Tekf5oTMoqJIt1J-eKq8mGEkMV811&export=download">
                        Check My Cv here
                      </MaeLink>
                </span>
                                <FontAwesomeIcon icon={faFile}/>
