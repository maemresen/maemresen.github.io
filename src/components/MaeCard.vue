<template>
  <div class="mae-card jumbotron text-secondary">
    <div>
      <div class="row">
        ...
        <div class="col-lg-6 d-flex align-items-center justify-content-center">
          <div>
            <h1 class="mae-text-green">
              {{ title }}
            </h1>
            <h3 class="text-secondary">{{ subtitle }}</h3>
            <div class="mt-4">
              <div
                class="d-inline-block icon-link"
    ...
    <div :class="cardSectionClass">
      <h5>
        <a href="https://cv.yazilim.vip/mehmet-arif-emre-sen.pdf" target="_blank" class="text-secondary mae-link">
      ...
      <h5>
        ...
        <div>
          ...
          >
            ...
            <span class="mx-3">Preffered Distro: Manjaro XFCE</span>
